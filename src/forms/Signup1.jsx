...
function Signup1()
 {
    let doSignup=(event)=>{
        ...
        //alert(email+"   "+pwd);
        event.target.txtBoth.value=email+"   "+pwd;
    }
              ...
              <div className="mx-auto max-w-xs sm:max-w-md md:max-w-lg flex flex-col gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    type="text"
                    placeholder="Exsisting business"
                  />
                  <br></br>
                  <h3>
                    doing since:
                ...
                <div className={`xl:max-w-2X1 ${darkMode ? "bg-black" : "bg-white"} w-full p-5 sm:p-10 rounded-md`}>
            <h2 className={`text-center text-sm sm:text-3xl font-semibold ${darkMode ? "text-white" : "text-black"}`}>
              Cite information: 
            </h2>
            </div>
                <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    type="text"
                    placeholder="TOal area in sq-m(l,b)"
                  />
                  <input
                    className={`w-full px-5 py-3 rounded-lg font-medium border-2 border-transparent placeholder-gray-500 text-sm focus:outline-none focus:border-2 ${
                      darkMode ? "bg-[#302E30] text-white focus:border-white" : "bg-gray-100 text-black focus:border-black"
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <h1>Ownership sattus: </h1>
                  <input type="radio" name="hey"/>Owner
                  <input type="radio" name="hey"/>Rent
                </div>
